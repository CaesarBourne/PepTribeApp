...
import com.bourne.caesar.peptribeconcept.AnimeActivity;
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder> {
    ...
    public MoviesAdapter(Context mContext, List<Anime> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.design_row,parent,false) ;
